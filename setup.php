...
switch ($action) {
        ...
        case '4':
                ...
                $page.="<br><span class=\"testo\">$string[step_4_2]</span><br><br>";
                $page.="<textarea name=\"mainscript\" cols=\"100%\" rows=\"6\">";
                $page.="<script language=\"javascript\" src=\"$option[script_url]/php-stats.js.php\"></script>\n<noscript><img src=\"$option[script_url]/php-stats.php\" border=\"0\" alt=\"\"></noscript>";
                $page.="</textarea><br><br>\n";
...
$html.="              <TD vAlign=bottom align=right><FONT face=verdana size=1>PHP-STATS INSTALLER (v1.2)</FONT></TD>";
$html.="            </TR>";
$html.="        </TABLE>";
$html.="	  </TD>";
$html.="    </TR>";
