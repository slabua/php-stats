...
if(!isset($option['prefix']) OR $option['prefix']=="") $option['prefix']="php_stats";
...
switch ($what) {
  ...
  case 'referer':
  $count=1;
   $body.="<center><font size=\"5\">$string[se_title]</font><br>";
   $body.="<font size=\"1\">$gen_on</font><br><br>";
   $body.="</center>";
   $body.="<center><table width=\"500\" align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">";
  ...
  case 'query':
  $count=1;
  $body.="<center><font size=\"5\">$string[query_title]</font><br>";
  $body.="<font size=\"1\">$gen_on</font><br><br>";
  $body.="</center>";
  $body.="<center><table width=\"500\" align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">";
...
$page ="<html>\n";
$page.="<head>\n";
$page.="<title>Php-Stat PRO v.$option[phpstats_ver]</title>\n";
$page.="<META NAME=\"ROBOTS\" CONTENT=\"NONE\">\n";
$page.="<style type=\"text/css\">";
$page.="a:visited,a:active {text-decoration:none; color:#000000; font-weight:plain;}";
$page.="a:hover {text-decoration:none; color:#AA0000; font-weight: plain;}";
$page.="a:link { text-decoration:none; color:#000000; font-weight:plain; }";
$page.="</style>";
$page.="</head>\n";
$page.="<body>\n";
$page.=$body."\n";
$page.="<br><CENTER><FONT face=verdana size=1>Php-Stats $option[phpstats_ver] © <a href=\"http://www.php-stats.com\">Webmaster76</a></FONT></CENTER>\n";
$page.="</body>";
//Output the html
echo"$page";
