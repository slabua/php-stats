...
$return.="\n</script>";
  ...
  $return.="<form method=\"POST\" action=\"../admin.php?action=preferenze\" name=\"formradio\">";
  ...
  if($option['stile']=="0") { $return.="checked"; }
  $return.="></td><td bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">$pref[style_2]</span></tr></td>";
  ...
  while(list($key,$val)=each($elenco)) 
    ...
    if($val==$option['stile']) $return.="checked";
    $return.=" onclick=\"javascript:vai(this);\" class=\"radio\"></span></td><td bgcolor=$style[table_bgcolor]>";
