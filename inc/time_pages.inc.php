...
if($num_totale>0)
  ...
  while($row=@mysql_fetch_array($result))
	...
	$return.="<td bgcolor=$style[table_bgcolor] align=\"left\"><span class=\"tabletextA\">".formaturl($row[0],$row[5],60,25,-25,$row[5],$mode)."</span></td>";
  ...
  if($numero_pagine>1)
    ...
    $return.=pag_bar("admin.php?action=time_pages&sort=$sort&order=$order&mode=$mode",$pagina_corrente,$numero_pagine,$rec_pag);
    $return.= "<tr><td height=\"1\" bgcolor=$style[table_title_bgcolor] colspan=\"4\" nowrap></td></tr>";
    }
  $return.="</table>";
  // SELEZIONE MODALITA'
