...
if($mode=="reset")
  ...
  elseif(!is_writable("php-stats.log"))
	...
	if(trim($log)!="") 
      ...
      $return.="<form action=\"admin.php?action=viewerrorlog\" method=\"post\"><input type=\"hidden\" name=\"mode\" value=\"reset\"><input type=\"submit\" value=\"".$string['viewerrlog_reset']."\"></center></form>";
	  }
	  else
