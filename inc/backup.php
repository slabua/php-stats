...
// |_| |_||_|_|0.1.8|___/ |_/_/ \_\_| |___/ |_| |_|_\\___/  //
//                                                          //
//////////////////////////////////////////////////////////////
//           Site url: http://www.webmaster76.com           //
//   Discussion Board: http://www.php-stats.com/forum/    //
//             E-mail: webmaster76@inwind.it                //
//////////////////////////////////////////////////////////////
...
while($statrow=@mysql_fetch_array($result))
        {
        $table_name=$statrow[0];
        // ESEGUO IL BACKUP DELLE SOLE TABELLE DI PHP-STATS
        $testnamestat=strstr($table_name,"$option[prefix]_");
//        $nodumptable=$option[prefix]."_ip_zone";
//        if($table_name==$nodumptable) $testnamestat=0;
if($testnamestat) {
$str.="
#
