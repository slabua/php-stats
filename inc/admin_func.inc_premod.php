...
// Troncatura URL //
function formaturl($url, $title="", $maxwidth=60, $width1=15, $width2=-20, $link_title="") {
  ...
  if($title=="/") $title="<img src=\"templates/$option[template]/images/icon_home.gif\" border=\"0\" title=\"$link_title\">";
    else
    if($flag) $title="<img src=\"templates/$option[template]/images/icon_home.gif\" border=\"0\">".$title;
  return "<a href=\"$url\" title=\"$link_title\" target=\"_blank\">".str_replace("\\\"", "\"", $title)."</a>";
  }
